...
class ContactListView: UIView {
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(ContactCellView.self, forCellReuseIdentifier: ContactCellView.classIdentifier())
...
extension ContactListView: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: ContactCellView.classIdentifier(), for: indexPath) as? ContactCellView
